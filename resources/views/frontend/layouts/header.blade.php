            ...
            <div class="hidden w-full lg:flex lg:w-auto" id="mobile-menu">
                <ul class="flex flex-col font-medium lg:flex-row lg:space-x-3 lg:mt-0">
                    ...
                    <li class="group" id="dropdown">
                        ...
                        <!-- Dropdown Content -->
                        <div class="absolute hidden group-hover:block bg-white shadow-xl mt-2 py-2 px-2 rounded border-2 border-gray-200 focus:border-green-500 focus:ring-green-500 w-40 z-10"
                            id="dropdown-menu">
                            @foreach ($menu->pages as $item)
                            <a href="{{ route('blank', $item->slug) }}"
                                class="block w-auto px-2 rounded-sm py-2 text-sm text-gray-700 hover:bg-green-500 hover:text-white">
                                {{ $item->name }}
                            </a>
                            @endforeach
                        </div>
                    ...
                    <li>
                        <a href="{{ route('peserta') }}"
                            class="block py-2 pr-4 pl-3 rounded lg:border-0 lg:p-2 hover:bg-green-500 hover:text-white">Data
                            Peserta</a>
                    </li>
