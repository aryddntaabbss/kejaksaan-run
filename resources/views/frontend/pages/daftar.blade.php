    ...
    <div class="w-full max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row justify-center space-y-6 md:space-y-0 md:space-x-6">
            ...
            <div class="w-full lg:w-3/6 bg-white border rounded-lg xl:p-6 p-3 text-center shadow-xl" data-aos="fade-up"
                ...
                <div class="text-2xl font-bold text-green-400 mb-2">Rp. {{ $road_race->biaya }}</div>
            ...
            <div class="w-full bg-white p-6 shadow-xl rounded-lg" data-aos="fade-up" data-aos-duration="1500">
                ...
                <form @if (!$tanggalEvent->isPast()) action="{{ route('peserta.store') }}" method="POST"
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" name="nama_lengkap" id="nama_lengkap" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 
        @error('nama_lengkap') border-red-500 @enderror" value="{{ old('nama_lengkap') }}">
                        @error('nama_lengkap')
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="number" name="nik" id="nik" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 
        @error('nik') border-red-500 @enderror" value="{{ old('nik') }}">
                        @error('nik')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" name="pekerjaan" id="pekerjaan" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 
        @error('pekerjaan') border-red-500 @enderror" value="{{ old('pekerjaan') }}">
                        @error('pekerjaan')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="number" name="no_tlp" id="no_tlp" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 
        @error('no_tlp') border-red-500 @enderror" value="{{ old('no_tlp') }}">
                        @error('no_tlp')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" name="alamat" id="alamat" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 
        @error('alamat') border-red-500 @enderror" value="{{ old('alamat') }}">
                        @error('alamat')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" name="komunitas" id="komunitas" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 
        @error('komunitas') border-red-500 @enderror" value="{{ old('komunitas') }}">
                        @error('komunitas')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-1">
                        <label for="riwayat_penyakit" class="block text-sm font-medium text-gray-700">Riwayat
                            Penyakit</label>
                        <input type="text" name="riwayat_penyakit" id="riwayat_penyakit" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 
        @error('riwayat_penyakit') border-red-500 @enderror" value="{{ old('riwayat_penyakit') }}">
                    ...
                    <div class="col-span-1">
                        <label for="kontak_darurat" class="block text-sm font-medium text-gray-700">Kontak
                            Darurat</label>
                        <input type="text" name="kontak_darurat" id="kontak_darurat" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 
        @error('kontak_darurat') border-red-500 @enderror" value="{{ old('kontak_darurat') }}">
                    ...
                    <div class="col-span-1">
                        <label for="golongan_darah" class="block text-sm font-medium text-gray-700">Golongan
                            Darah</label>
                        <select name="golongan_darah" id="golongan_darah" required class="mt-1 p-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 
        @error('golongan_darah') border-red-500 @enderror">
                    ...
                    <div class="col-span-1">
                        ...
                        <select name="size_jersey" id="size_jersey" required class="mt-1 p-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500
